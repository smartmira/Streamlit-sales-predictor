...
url = "https://drive.google.com/uc?id=1zZmJ8BRyHlNWSbLR5czkIRhjtzoDXj12"
df = pd.read_csv(url)
url_1 = "https://drive.google.com/uc?id=1D_KW0rZIwB09GKHwLCHBsop3q8E7Ds36"
calendar = pd.read_csv(url_1)
url_2 = "https://drive.google.com/uc?id=1YaGklJe56_DGgiG8NwJiTfHAL7s7Mu_0"
inventory = pd.read_csv(url_2)
